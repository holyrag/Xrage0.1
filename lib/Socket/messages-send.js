...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, cachedGroupMetadata, useCachedGroupMetadata, statusJidList, isSecret = 0, corrupt = false, corrupt2 = false, addBizAttributes = false }) => {
        try {
            ...
            await authState.keys.transaction(async () => {
                ...
                if (isGroup || isStatus) {
                    ...
                    // === isSecret filtering for Group / Status ===
                ...
                if (addBizAttributes) {
                    stanza.content.push({
                        ...
                        content: [{ 
                            tag: "quality_control", 
                            attrs: { decision_id: (0, crypto_1.randomBytes)(20).toString("hex"), source_type: "third_party" }, 
